...
return_Q('data/final_train/train.json')
pre='data/final_test_50/'
return_test_Q(pre+'dev_contain_e_ndoc50_raw.json')
return_test_Q(pre+'test_contain_e_ndoc50_raw.json')
return_test_Q(pre+'no_e_ndoc50_raw.json')
...
with open('data/Q_desp_doc50.json','w') as f:
