...
valid_sample=True
contain=False
# add   sample['multi_ans'],sample['multi_ans_real'],sample['ans_mention'].append([c,e2_id])
...
#test_file='/media/xuweijia/06CE5DF1CE5DD98F/useful_old_data/new_NER_data/e_30/up_30/{}_contain_e.json'.format(mode)
if contain:
    test_file='{}_contain_e.json'.format(mode)
else:
    test_file='no_e.json'
...
for n,sample in enumerate(samples):
    ...
    valid_c=sample['valid_cands'] if valid_sample else sample['candis']
...
print(mode,'valid cands:', valid_sample)
...
if contain:
    dict_file='dict_p_{}_{}.json'.format(mode,valid_sample)
else:
    dict_file='dict_no_e.json'
...
# valid_cands 
#dev valid cands: True
#avrage entity each mention linked: 5.152875285950935
#avrage entity each ans mention linked: 1.6364518162859498
#average can each sample have: 20.671567518660936
#have_ans_rate: 0.7835331372992536
#how many ahchor can't be NER: 0.4742548113542883
#how many valid candidas can't be NER: 0.5408139948204946
#how many samples  have multiple answear: 0.08595340420719294
#how many samples  have multiple answear real: 0.019226419362135264
#average ans each sample contain: 1.1167156751866094
#average ans each sample contain real: 1.0214883510517982
    
#test valid cands: True
#avrage entity each mention linked: 5.628551804838341
#avrage entity each ans mention linked: 1.7658444410397836
#average can each sample have: 20.34126627750337
#have_ans_rate: 0.7817691962281096
#how many ahchor can't be NER: 0.4728209282016883
#how many valid candidas can't be NER: 0.5387974130839229
#how many samples  have multiple answear: 0.07049842837898518
#how many samples  have multiple answear real: 0.017512348450830714
#average ans each sample contain: 1.0958688819039066
#average ans each sample contain real: 1.01930848675348
    
# no_e
#test valid cands: True
#avrage entity each mention linked: 5.596456263818391
#avrage entity each ans mention linked: 2.0674347678752967
#average can each sample have: 21.935284810126582
#have_ans_rate: 0.7935126582278481
#how many ahchor can't be NER: 0.5526702863680111
#how many valid candidas can't be NER: 0.6253064337467541
#how many samples  have multiple answear: 0.1661392405063291
#how many samples  have multiple answear real: 0.05237341772151899
#average ans each sample contain: 1.741139240506329
#average ans each sample contain real: 1.0957278481012658