...
with open('data/dict_p_{}_{}.json'.format(mode,valid_sample),'w') as f:
...
#avrage entity each ans mention linked: 1.6363592280089225
#average can each sample have: 20.677674734223025
#have_ans_rate: 0.7835331372992536
#how many ahchor can't be NER: 0.34804595047047276
#how many valid candidas can't be NER: 0.3477919528949951
...
#avrage entity each mention linked: 5.628967446592065
#avrage entity each ans mention linked: 1.7657271241830066
#average can each sample have: 20.348148148148148
#have_ans_rate: 0.7820426487093154
#how many ahchor can't be NER: 0.3488641445821818
#how many valid candidas can't be NER: 0.34843984725296145
#how many samples  have multiple answear: 0.0707070707070707
#how many samples  have multiple answear real: 0.017508417508417508
#average ans each sample contain: 1.0965207631874299
#average ans each sample contain real: 1.019304152637486
   
    
# cands
# dev 
#dev valid cands: False
#avrage entity each mention linked: 5.153041100212995
#avrage entity each ans mention linked: 1.639055271487704
#average can each sample have: 20.677674734223025
#have_ans_rate: 0.7835331372992536
#how many ahchor can't be NER: 0.34804595047047276
#how many valid candidas can't be NER: 0.3477919528949951
...
#    
#test valid cands: False
#avrage entity each mention linked: 5.628967446592065
#avrage entity each ans mention linked: 1.7690650802605261
#average can each sample have: 20.348148148148148
#have_ans_rate: 0.7820426487093154
#how many ahchor can't be NER: 0.3488641445821818
#how many valid candidas can't be NER: 0.34843984725296145
